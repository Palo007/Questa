# Maintainer: syncing from the Google AI Studio build

> **This is not an install guide.** It is the private maintainer workflow for
> pulling an internal Google AI Studio build into this repository. The remote it
> uses is not public, so nobody else can run any of it.
>
> If you want to *run* Questa, read [INSTALL.md](../INSTALL.md) instead.
>
> Moved here on 2026-09-18 (review Part 3, blocker 2): `README.md` used to point
> newcomers at this text as the install instructions, and nothing anywhere said
> how to actually start the app. The content is kept verbatim below, minus its
> original title.
